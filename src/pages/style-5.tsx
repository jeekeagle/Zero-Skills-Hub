...
import styles from './style-5.module.css';
    ...
    <header className={clsx('hero', styles.heroBanner)}>
      <div className="container">
        ...
        <p className={styles.lead}>
          视角 + 工具 = 可交付的认知。每条建议都有理论锚点,反坍缩闸兜底。
        </p>
        ...
        <div className={styles.skillsGrid}>
          {SKILLS.map((s, i) => (
            <Link key={s.name} to={s.to} className={styles.skillCard}>
              <div className={styles.skillIndex}>{String(i + 1).padStart(2, '0')}</div>
              ...
              <div className={styles.skillLink}>查看 →</div>
            </Link>
          ))}
        </div>
      </div>
